...
public class A1Novice {
	...
	public static void main(String[] args) {
		...
		// declares and instantiates a new array of Customers based on the number of
		// customers
		...
		for (int i = 0; i < numofcustomers; i++) {
			...
			for (int j = 0; j < customers[i].numitemsbought; j++) {
				...
				// adds a new item to the array of items for that customer with inputed
				// parameters
				customers[i].itemsbought[j] = new Item(frequency, name, price);

				// calculates and sets the amount spent for each customer by accessing each item
				// bought by that customer and the frequency of each
...
// this class defines the object Customer - the class holds instance variables
// for the name,number of items bought, amount total spent, 
//and an array of the items bought by that customer
...
class Customer {
	...
	// takes the amount sent as a parameter and adds it to the instance variable
	// tracking total amount spent
...
// this class defines the object Item which holds instance data for the price
// and name of the item as well as the number of customers who bought that item
